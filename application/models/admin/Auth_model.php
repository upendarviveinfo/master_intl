...
class Auth_model extends CI_Model{
	...
	public function login($data){
		...
		$this->db->join('admin_roles','admin_login.admin_role_id = admin_roles.admin_role_id');
		$this->db->where('admin_login.username', $data['username']);
		$this->db->where('admin_login.password', $data['password']);
