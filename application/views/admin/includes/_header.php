...
<head>
  ...
  <title><?= isset($title)? $title.' - ' : 'Title -' ?> TE ADMIN PANEL</title>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php// base_url('home/site_lang/'.$lang['id']) ?>" class="dropdown-item">
            <i class="fa fa-flag mr-2"></i> English <?php//$lang['name'] ?>
          </a>
