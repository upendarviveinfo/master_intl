...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url('admin'); ?>" class="brand-link">
    <img src="<?= base_url()?>assets/img/dc48701e5a6a300744b873b63f772101.png" alt="Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li id="<?= ($nav['control_name']) ?>" class="nav-item <?= ($has_submenu) ? 'has-treeview' : '' ?> has-treeview">

          <a href="<?= base_url('admin/'.$nav['control_name']) ?>" class="nav-link">
            <i class="nav-icon fa"></i>
            <p>
              <?= trans($nav['control_name']) ?>
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?= base_url('admin/'.$nav['control_name'].'/'.$sub_nav['link']); ?>" class="nav-link">
                <i class="fa fa-circle-o nav-icon"></i>
                <p><?= trans($sub_nav['control_name']) ?></p>
              </a>
            </li>
